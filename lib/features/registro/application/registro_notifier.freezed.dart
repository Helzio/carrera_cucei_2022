...
part of 'registro_notifier.dart';
...
abstract class $RegistroStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      String semestre,
      bool loading,
      Option<Either<RegistroFailure, Unit>> option});
}
    ...
    return _then(_value.copyWith(
      ...
      option: option == freezed
          ...
          : option // ignore: cast_nullable_to_non_nullable
              as Option<Either<RegistroFailure, Unit>>,
    ));
  }
}
...
class _$_RegistroState extends _RegistroState {
  const _$_RegistroState(
  ...
  final bool loading;
  @override
  final Option<Either<RegistroFailure, Unit>> option;

  @override
  String toString() {
    return 'RegistroState(nombre: $nombre, codigo: $codigo, password: $password, telefono: $telefono, email: $email, escuela: $escuela, semestre: $semestre, loading: $loading, option: $option)';
  }
